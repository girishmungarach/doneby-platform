-- First, let's add the missing columns we need
...
DROP POLICY IF EXISTS "Users can view verified timeline entries of others" ON timeline_entries;
DROP POLICY IF EXISTS "Users can manage their own timeline entries" ON timeline_entries;
DROP POLICY IF EXISTS "Users can view their own verifications" ON verifications;
DROP POLICY IF EXISTS "Users can view verifications they verified" ON verifications;
DROP POLICY IF EXISTS "Users can create verifications for themselves" ON verifications;
DROP POLICY IF EXISTS "Verifiers can update verifications they're assigned to" ON verifications;
DROP POLICY IF EXISTS "Anyone can view published jobs" ON jobs;
DROP POLICY IF EXISTS "Only verified organizations can create jobs" ON jobs;
DROP POLICY IF EXISTS "Organization members can manage their jobs" ON jobs;
DROP POLICY IF EXISTS "Users can view their own applications" ON applications;
DROP POLICY IF EXISTS "Users can create applications" ON applications;
DROP POLICY IF EXISTS "Organization members can view applications for their jobs" ON applications;
DROP POLICY IF EXISTS "Organization members can update applications for their jobs" ON applications;
DROP POLICY IF EXISTS "Anyone can view published surveys" ON surveys;
DROP POLICY IF EXISTS "Organization members can view their surveys" ON surveys;
DROP POLICY IF EXISTS "Organization members can manage their surveys" ON surveys;
...
DROP POLICY IF EXISTS "Organization members can view responses to their surveys" ON survey_responses;
